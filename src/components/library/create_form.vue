<template>
    <div class=" bg-white rounded-lg shadow dark:border mt-24 sm:max-w-md mx-auto xl:p-0 dark:bg-gray-800 dark:border-gray-700">
...
<script setup lang="ts">
    defineProps<{source: 'folder' | 'library'}>()
</script>