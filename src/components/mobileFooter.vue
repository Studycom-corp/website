    ...
    <div class="w-full h-16 bg-slate-300 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            <button @click="selectNav('home')" data-tooltip-target="tooltip-home" type="button" class="inline-flex flex-col items-center justify-center px-5">
                <svg class="w-7 h-8 mb-1" :class="{'text-slate-900 dark:text-gray-400': activeTab != 'home', 'text-blue-600': activeTab == 'home'}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button @click="selectNav('libraries')" type="button" class="inline-flex flex-col items-center justify-center px-5">
                <svg class="w-9 h-9 mb-1" :class="{'text-slate-900 dark:text-gray-400': activeTab != 'libraries', 'text-blue-600': activeTab == 'libraries'}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div @click="selectNav('create new')" class="flex items-center justify-center">
                <button data-tooltip-target="tooltip-new" type="button" :class="{'bg-blue-600': activeTab == 'create new', 'bg-slate-900 dark:bg-gray-400': activeTab != 'create new'}" class="inline-flex items-center justify-center w-10 h-10 font-medium  rounded-full">
            ...
            <button @click="selectNav('search')" data-tooltip-target="tooltip-settings" type="button" class="inline-flex flex-col items-center justify-center px-5">
                <svg v-if="activeTab != 'search'" class="w-8 h-8 mb-1 text-slate-900 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <button @click="selectNav('profile')" type="button" class="inline-flex flex-col items-center justify-center px-5">
                <svg class="w-8 h-8 mb-1 overflow-hidden rounded-full" :class="{'text-slate-900 dark:text-gray-400': activeTab != 'profile', 'text-blue-600 dark:bg-white': activeTab == 'profile'}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
