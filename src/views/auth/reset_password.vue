            ...
            <div class="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                    ...
                    <div class="space-y-2">
                        ...
                        <button @click="$router.push({name: 'login'})" class="w-full text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center border border-orange-600 bg-transparent hover:bg-orange-700">Discard</button>
                    </div>
                </form>
            </div>
        </div>
